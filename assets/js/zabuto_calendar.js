            ...
            for (var wk = 0; wk < weeksInMonth; wk++) {
                ...
                for (var dow = 0; dow < 7; dow++) {
                    if (dow < firstDow || currDayOfMonth > lastDayinMonth) {
                        ...
                        var dateId = dateAsString(currDayOfMonth, month, year);
                        ...
                        //mexi aqui
                        if(document.getElementById('dataSelecionada')){
                            var dataSelecionada = document.getElementById('dataSelecionada').value;
                            var dataSelecionadaArray = dataSelecionada.split("/");
                            //alert (dataSelecionadaArray[1]+ "," + month);
                            var dataSelecionadaFormatada = new Date(dataSelecionadaArray[2], dataSelecionadaArray[1]-1, dataSelecionadaArray[0]);
                            var dateComparar = new Date(year, month, currDayOfMonth);
                            if(dataSelecionadaFormatada.toDateString() == dateComparar.toDateString()){
                                //alert (dataSelecionadaFormatada + "e igual a "+ dateComparar);
                                $dayElement.html('<span class="badge badge-selecionado">' + currDayOfMonth + '</span>');
                            }
                        }
                        //ate aqui
